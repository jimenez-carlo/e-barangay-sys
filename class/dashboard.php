...
class Dashboard extends Base
{
  ...
  public function get_data()
  {
    ...
    $data->barangay_total = $this->get_one("select count(*) as count from tbl_request_barangay where deleted_flag = 0 and request_status_id  in (1,2,4,5,6)");
    ...
    $data->business_total = $this->get_one("select count(*) as count from tbl_request_business where deleted_flag = 0 and request_status_id  in (1,2,4,5,6)");
    ...
    $data->id_total = $this->get_one("select count(*) as count from tbl_request_id where deleted_flag = 0 and request_status_id  in (1,2,4,5,6)");
