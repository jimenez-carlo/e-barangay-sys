...
<head>
  ...
  <link rel="stylesheet" href="css/datatable_button.css">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <!-- <li class="active"><a href="#" class="btn-view" name="admin/home"><i class="fa fa-home"></i> <span>Dashboard</span></a></li> -->
          ...
          <li class="treeview">
            <a href="#"><i class="fa fa-files-o"></i> <span>Document Requests</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href="#" class="btn-view" name="admin/business"><i class="fa fa-files-o"></i> <span>Business Clearance</span></a></li>
              <li><a href="#" class="btn-view" name="admin/barangay"><i class="fa fa-files-o"></i> <span>Barangay Clearance</span></a></li>
              <li><a href="#" class="btn-view" name="admin/id"><i class="fa fa-files-o"></i> <span>Barangay ID</span></a></li>
            </ul>
          </li>
          ...
          <li><a href="#" class="btn-view" name="admin/settings/edit" value="1"><i class="fa fa-cog"></i> <span>Settings</span></a></li>
          <!-- <li class="treeview">
