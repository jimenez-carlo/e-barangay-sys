          ...
          <div class="box-body">
            ...
            <div class="form-group col-xs-4">
              ...
              <div class="input-group date">
                ...
                <input type="text" class="form-control pull-right datepicker" name="birth_date" placeholder="09XXXXXXXXX" value="<?= $data->contact_no; ?>" name="start_date">
              </div>
            </div>
            ...
            <div class="form-group col-xs-4">
              ...
              <div class="input-group date">
                ...
                <input type="text" class="form-control pull-right" name="contact_no" placeholder="09XXXXXXXXX" value="<?= $data->contact_no; ?>" name="start_date">
              </div>
            </div>
      ...
      <div class="col-xs-3">
        <div class="box box-success">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-sm btn-success btn-flat" name="resident_update" value="verify"><i class="fa fa-check"></i> Verify</button>
          </div>
        </div>
      </div>
    </div>
