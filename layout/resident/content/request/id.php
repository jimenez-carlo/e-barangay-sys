        ...
        <div class="box box-success">
          ...
          <div class="box-body">
            <div class="form-group col-xs-3">
              ...
              <input type="text" class="form-control" value="<?php echo $default_data['barangay_id']; ?>" disabled>
            </div>
            ...
            <div class="form-group col-xs-3">
              ...
              <input type="file" class="form-control" name="government_id" style="display:block">
            </div>
            <div class="form-group col-xs-3">
              <label for="exampleInputPassword1">*2x2 picture (white background)
              </label>
              <input type="file" class="form-control" name="picture" style="display:block">
            </div>
            <div class="form-group col-xs-3">
              <label for="exampleInputPassword1">*Scanned signature
              </label>
              <input type="file" class="form-control" name="signature" style="display:block">
            </div>
