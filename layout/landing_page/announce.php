    ...
    <body>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-7">
                    <img class="d-blobk w-100" src="../../assets/img/tuli.jpg" height="400px" alt="..." style="object-fit: contain; background-color:gray;"  />


                </div>
                <div class="col-lg-5">
                    <h1 class="font-weight-light">Announcement Title</h1>
            ...
            <div class="row gx-4 gx-lg-5">
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            <h2 class="card-title">Other Announcement</h2>
