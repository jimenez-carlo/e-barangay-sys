...
LOCK TABLES `tbl_blood_type` WRITE;
/*!40000 ALTER TABLE `tbl_blood_type` DISABLE KEYS */;
INSERT INTO `tbl_blood_type` VALUES (1,'A +'),(2,'A -'),(3,'B +'),(4,'B -'),(5,'O +'),(6,'O -'),(7,'AB +'),(8,'AB -');
/*!40000 ALTER TABLE `tbl_blood_type` ENABLE KEYS */;
UNLOCK TABLES;
